    ...
    export default {
        ...
        methods: {
            ...
            async getResturants(){
                ...
                let restaurantsData = await getResturants({latitude, longitude, offset: this.offset, limit: this.limit});
            ...
            async querySearchAsync(queryString, cb) {
                if (queryString) {
                    try{
                        ...
                        const cityList = cityListData.data
            ...
            handleServiceAvatarScucess(res, file) {
                if (res.status == 200) {
                    this.selectTable.image_path = baseUrl + res.data;
                }else{
